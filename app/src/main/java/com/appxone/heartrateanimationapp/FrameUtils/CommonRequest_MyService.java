...
public class CommonRequest_MyService extends AsyncTask<String, String, String> {
	...
	private MyService activity;
	private MyService context;

	public CommonRequest_MyService(Context context) {
		super();
	...
	public void setActivity(MyService activity) {
